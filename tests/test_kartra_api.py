...
class TestKartraRoutes(unittest.IsolatedAsyncioTestCase):
    ...
    #     r = await kartra_api.KartraPost.fetch_post_info(
    #         self.post_id,
    #         self.course_id,
    #     )
    ...
    async def test_get_post_subcategories(self):
        r = kartra_api.fetch_all_post_ids(self.course_id)
